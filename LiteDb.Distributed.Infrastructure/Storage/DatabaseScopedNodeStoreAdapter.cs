...
public sealed class DatabaseScopedNodeStoreAdapter :
    ...
    IClusterPeerRegistry
{
    ...
    public async Task<WriteResult> UpsertAsync<TDocument>(
        string collection,
        string entityId,
        TDocument document,
    ...
    public async Task<IReadOnlyList<TDocument>> ListAsync<TDocument>(
        string collection,
        int skip = 0,
        int take = 100,
        CancellationToken cancellationToken = default)
    ...
    public async Task<IReadOnlyList<OperationRecord>> GetOperationsAfterLogSequenceAsync(
    ...
    public async Task<IReadOnlyList<OperationRecord>> GetLocalOperationsAfterSequenceAsync(
        string nodeId,
        long afterSequence,
        int batchSize,
        CancellationToken cancellationToken = default)
    ...
    public async Task<PeerCheckpointRecord> GetOrCreatePeerCheckpointAsync(
        string localNodeId,
        string peerNodeId,
        CancellationToken cancellationToken = default)
    {
    ...
    public async Task SavePeerCheckpointAsync(
    ...
    public async Task<bool> ApplyRemoteOperationAsync(
