...
using DistributedLiteDb.Core.Exceptions;
using DistributedLiteDb.Core.Models;
using DistributedLiteDb.Infrastructure;
...
var nodeOptions = new ClusterNodeOptions
{
    ...
    DatabasePath = builder.Configuration["Node:DatabasePath"] ?? Path.Combine("Data", "node-1.db"),
...
builder.Services.AddDistributedLiteDbNode(nodeOptions);
