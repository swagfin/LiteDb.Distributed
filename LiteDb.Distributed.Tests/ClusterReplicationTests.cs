    ...
    public class ClusterReplicationTests
    {
        ...
        public async Task OperationLogPruning_PrunesOnlyOperationsCoveredByActivePeerCheckpoints()
        {
            ...
            try
            {
                ...
                await store.UpsertAsync(CustomerCollection, "cust-prune-001", new Customer { Id = "cust-prune-001", Name = "One", Email = "one@example.com", UpdatedUtc = DateTime.UtcNow });
                await store.UpsertAsync(CustomerCollection, "cust-prune-002", new Customer { Id = "cust-prune-002", Name = "Two", Email = "two@example.com", UpdatedUtc = DateTime.UtcNow });
                await store.UpsertAsync(CustomerCollection, "cust-prune-003", new Customer { Id = "cust-prune-003", Name = "Three", Email = "three@example.com", UpdatedUtc = DateTime.UtcNow });
        ...
        public async Task OperationLogPruning_KeepsReceiptSoDuplicatePrunedOperationIsNotReapplied()
        {
            ...
            try
            {
                ...
                await sourceStore.UpsertAsync(CustomerCollection, "cust-prune-dup-001", new Customer { Id = "cust-prune-dup-001", Name = "Original", Email = "original@example.com", UpdatedUtc = DateTime.UtcNow });
        ...
        public async Task OperationReceiptPruning_RemovesReceiptsOlderThanRetentionCutoff()
        {
            ...
            try
            {
                ...
                await sourceStore.UpsertAsync(CustomerCollection, "cust-receipt-prune-001", new Customer { Id = "cust-receipt-prune-001", Name = "Receipt", Email = "receipt@example.com", UpdatedUtc = DateTime.UtcNow });
                OperationRecord operation = (await sourceStore.GetOperationsAfterLogSequenceAsync(0, 10)).Single();
                OperationIngestionService ingestionService = new OperationIngestionService(targetStore, new NodeConflictPolicyResolver("ApplyIncoming"), targetStore, targetStore, NullLogger<OperationIngestionService>.Instance);
